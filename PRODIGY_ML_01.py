...
#Gradient descent with regularisation to find minmum theta
...
#Normal equaion function with regularisation to find minimum theta
...
#Train the model with train data and predict the test data using gradient descent.

#Compute the minimum error and lambda.

#Plot error vs lambda graph.
...
#Train the model with train data and predict the test data using Normal Equation.
